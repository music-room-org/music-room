...
function isAutoGeneratedTrack(channelTitle: string, description: string): boolean {
  ...
  const descriptionHasAutoGenerated = /provided to youtube|auto-generated by youtube|autogenerated by youtube/i.test(description || '');
...
export class YtApiService {
   ...
   * Automatically appends "- Topic" to search query to focus on auto-generated YouTube tracks.
   * Strictly filters results to only include tracks automatically generated by YouTube.
   */
  async searchTracks(query: string, maxResults = 10): Promise<TrackSearchResult[]> {
    ...
    const searchQuery = /-\s*topic$/i.test(trimmedQuery)
      ? trimmedQuery
      : `${trimmedQuery} - Topic`;
